...
async def dispatch_meta_tool(
    ...
    if name == TOOL_EXECUTE:
        ...
        # MCP args are untyped at runtime; validate dry_run is a real boolean so a
        # stray "false" string cannot accidentally enable dry-run (bool("false")
        # is True) or diverge from the declared schema.
        if (
