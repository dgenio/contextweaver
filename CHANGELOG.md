...
- Benchmark harness for routing and context pipeline (#119)
  ...
  - Tests 3 catalog sizes: 50, 83 (natural pool cap), and 1000 (synthetic extension); catalog sizes now generated with explicit `n` so each size reflects the intended sampling without synthetic contamination
