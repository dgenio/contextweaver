...
make readme-version-check  # verify README package/comparison/roadmap version references match pyproject.toml (gating CI step; #347/#531)
...
> `make readme-version-check` (#347/#531), `make context-rot-check` (#349),
