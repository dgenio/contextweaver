.PHONY: fmt lint type test example demo ci docs docs-serve benchmark benchmark-matrix scorecard scorecard-check architectures llms llms-check weaver-conformance sweep-scoring
