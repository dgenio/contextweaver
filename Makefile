...
ci: fmt lint type test drift-check module-size-check doc-snippets-check readme-version-check security-policy-check version-metadata-check schema-hosting-check example demo
